...
import logo from '../chop-n-shop-logo.PNG'; // Ensure this path is correct
...
const LandingPage = ({ onVisit }) => {
  return (
    <div className="min-h-screen bg-white dark:bg-spotifyBlack flex flex-col items-center justify-center font-inter">
      <img src={logo} alt="Chop N' Shop Logo" className="w-[300px] h-[206px] animate-slide-in mb-6" /> {/* Adjusted size and applied animation class */}
